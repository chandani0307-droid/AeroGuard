...
# --------------------------------------------------------------------------
# DATA LOADING (robust — file missing/mismatched ho to bhi crash nahi hoga)
# --------------------------------------------------------------------------
...
def compute_category_shares(engine_df: pd.DataFrame):
    """Category % ab engine/dataset ke actual data se compute hota hai,
    isliye selection change karne par values bhi change hongi."""
    scores = {}
